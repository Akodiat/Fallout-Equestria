...
public class TextureTest {
	...
	public static void main(String[] args) throws IOException, LWJGLException {
		...
		camera = new Camera2D(new Rectangle(-mode.getWidth(), 0, (int)(mode.getWidth() * 3), (int)(mode.getHeight() * 1.1f)), 
		...
		while(!Display.isCloseRequested()) {
			...
			//graphics.draw(font.getTexture(), new Rectangle(700,100,300,300), Color.Red, new Rectangle(0, 0, 100, 200));
			//graphics.draw(texture, new Rectangle(400,100,100,100), Color.Red, new Rectangle(0, 0, 40, 40));
			Vector2 fontDim = font.meassureString("123 123 123 123");
			
			
			graphics.drawString(font, "123 123 123 123", new Vector2(0,0), Color.Green, new Vector2(fontDim.X / 2, fontDim.Y / 2));
			graphics.end();
